...
防御： referer过滤，防止第三方访问用户cookie， 请求附带token信息去请求已经登录过的网站进行请求（session里面
...
本文分析了其他中间件的原理（还没看）
[Koa2 中间件原理解析 —— 看了就会写](https://segmentfault.com/a/1190000016707059)
从浅入深，还没看
...
$set原理（还没看
[搜索set](https://www.baidu.com/s?ie=utf-8&f=3&rsv_bp=1&tn=baidu&wd=vue%20%24set%E5%8E%9F%E7%90%86&oq=vue%2524set&rsv_pq=8642f9690005b009&rsv_t=c9d7VkKKzf40Jjpmg5CnSxvCm2sB02FsmTHHTCoE2PlA%2FLYClLEH51Xznx4&rqlang=cn&rsv_enter=0&rsv_dl=ts_2&rsv_btype=t&inputT=3119&rsv_sug3=14&rsv_sug1=14&rsv_sug7=100&rsv_sug2=0&prefixsug=vue%2520%2524set&rsp=2&rsv_sug4=3222)
...
隐患： 主要是属于
* csrf(cross site request forgery)数据劫持，伪造一个script标签，用户点击将发挥的东西发送到自己服务器上去请求已经登录过的网站进行请求
...
两个页面进行交换数据
nextTick
bfc: 块级格式上下文（规定内部如何布局，并内部区域跟外部无关
...
[vue源码之 eventBus原理](https://blog.csdn.net/m0_37754657/article/details/110086228?utm_medium=distribute.pc_relevant_t0.none-task-blog-2%7Edefault%7EBlogCommendFromMachineLearnPai2%7Edefault-1.control&dist_request_id=1331989.13171.16188203567707789&depth_1-utm_source=distribute.pc_relevant_t0.none-task-blog-2%7Edefault%7EBlogCommendFromMachineLearnPai2%7Edefault-1.control)
[【面试题】阐述一下VUE中 eventbus 的原理](https://blog.csdn.net/qq_45149256/article/details/112129291?utm_medium=distribute.pc_relevant.none-task-blog-baidujs_title-0&spm=1001.2101.3001.4242)
